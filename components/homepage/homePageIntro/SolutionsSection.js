    ...
    cards: [
      {
        ...
        desc: "Comprehensive data analytics training covering Excel, Power BI, Python, and SQL — equipping your team with skills employers actually want.",
        href: "/services/training-services/data-analysis-training",
      },
      {
        icon: "⚙️",
        title: "Software Development",
        desc: "Custom software and mobile applications built from the ground up — scalable, secure, and aligned to your business logic.",
        href: "/services/software-technology-services/web-application-development",
      },
      {
        icon: "📋",
        title: "Project Management Training",
        desc: "Agile, PMP, and Prince2-aligned training to help your teams deliver projects on time and on budget.",
        href: "/services/training-services/project-management-training",
      },
      {
        icon: "📊",
        title: "Business Analytics",
        desc: "Data-driven insights and dashboards that turn raw numbers into strategic decisions.",
        href: "/services/business-data-analytics",
      },
    ],
    cta: null,
  },
